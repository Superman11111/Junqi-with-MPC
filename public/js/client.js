var Client = (function(window) {
    ...
    */
    ...
    //使用target获取标签，调用highlight函数 参数rank为所在行数
  ...
  var attachDOMEventHandlers = function()
  {
    ...
    */
    ...
    // slectedSquare 是所选元素的标签 squares是所有的棋子  square是当前元素（棋子）
    var highlightValidSwap = function(piece, selectedSquare)
    {
        ...
        // Highlight any valid moves  在鼠标select某个棋子之后，更新其他棋子的valid-swap状态
